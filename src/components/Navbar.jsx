...
const Navbar = () => {
  ...
  return (
    <section className="flex items-center justify-between py-3">
      ...
      <nav
        ref={navRef}
        className="text-dimWhite translate-y-[-100vh] sm:translate-y-[0vh] transition-all sm:transition-none  sm:text-xs lg:text-[1rem] sm:relative fixed top-0 left-0 sm:h-0 h-full w-full flex sm:flex-row flex-col items-center justify-center sm:justify-end gap-3 bg-primary"
      >
